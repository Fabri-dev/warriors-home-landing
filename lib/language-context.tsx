...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "contact.form.submit": "Escribinos por Instagram",
    "contact.form.success.title": "¡Instagram abierto!",
    "contact.form.success.text": "Tu mensaje fue copiado al portapapeles. Pegalo en el chat de Instagram.",
    "contact.form.success.message_label": "Tu mensaje (ya copiado)",
    "contact.form.success.copy_again": "Copiar mensaje de nuevo",
    "contact.form.success.copied": "¡Copiado!",
    "contact.form.success.another": "Enviar otro mensaje",
  ...
  en: {
    ...
    "contact.form.online": "Online",
    "contact.form.submit": "Message us on Instagram",
    "contact.form.success.title": "Instagram opened!",
    "contact.form.success.text": "Your message was copied to clipboard. Paste it in the Instagram chat.",
    "contact.form.success.message_label": "Your message (already copied)",
    "contact.form.success.copy_again": "Copy message again",
